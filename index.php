...
<div class="why-choose-area bg-primaryText section-space-default">                
    <div class="container">
        <h2 class="title-textPrimary">Neden Bizi Tercih Ettiniz?</h2>  
    </div>
    <div class="container">
        <div class="row">
           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="why-choose-box">
                ...
                <h3><a href="#">Kolayca Satın al ve sat </a></h3>
...
<div class="author-banner-area">
    <div class="author-banner-wrapper">
        ...
        <div class="author-banner-content">
            <ul>
                <li><p>Eskiyi Değerlendir!</p></li>
                <li><a href="register.php" class="btn-fill-textPrimary">Bir Satıcı Olun</a></li>
            </ul>
        </div>
    </div>               
</div>
