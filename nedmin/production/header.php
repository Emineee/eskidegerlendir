  ...
  <div  class="container body">
    <div  class="main_container">
      <div  class="col-md-3 left_col">
        <div style="background-color:#575149;" class="left_col scroll-view">
          <div style="background-color:#575149;" class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Eskiyi Değerlendir</span></a>
          </div>
