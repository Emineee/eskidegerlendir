  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div style="background-color:#f1eedd" class="x_panel">
          <div class="x_title">
            ...
            <div align="right">
              <a href="kategori-ekle.php"><button class="btn btn-secondary btn-xs"> Yeni Ekle</button></a>
          ...
          <div class="x_content">
            ...
            <td><center><a href="kategori-duzenle.php?kategori_id=<?php echo $kategoricek['kategori_id']; ?>"><button class="btn btn-secondary btn-xs">Düzenle</button></a></center></td>
