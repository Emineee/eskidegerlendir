...
<head>
  ...
  <title>Eskiyi Değerlendir </title>
...
<body style="background-image: url(../../img/2.jpg);" class="login">
  <div>
      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <div>
            <button style="width: 100%; background-color:#987c2a; color:white;" type="submit" name="admingiris" class="btn btn-default"> Giriş Yap</button>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i>Zaman Eski'nin Zamanı</h1>
                <p>©2019</p>
              </div>
            </div>
          </form>
