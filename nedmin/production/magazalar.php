            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><center> <a onclick="return confirm('Mağazayı siteden kaldırmak istiyormusun?')" class="btn btn-danger" href="../netting/adminislem.php?magazaonay=red&kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>">Mağazayı Siteden Kaldır</a></center></td>
